...
print("==================================================")
print(" CTM A-TENSOR TRAINING (VALIDATING TRANSITIVITY) ")
print("==================================================")
...
plt.savefig("ctm_artifacts/visualizations/a_tensor_validation.png", bbox_inches='tight')
print("Saved visualization to: ctm_artifacts/visualizations/a_tensor_validation.png")
